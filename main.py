...
HOSPITAL_DATASETS = {
    'Hospital_1': [
        'datasets/JSIEC',#Considered public dataset (common among clients)
        'datasets/IDRiD', #Considered public dataset (common among clients)
        'datasets/APTOS2019',
        'datasets/MESSIDOR2'
    ],
    'Hospital_2': [
